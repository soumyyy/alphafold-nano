...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--episodes", type=int, default=20000, help="Training episodes")
    parser.add_argument("--gamma", type=float, default=0.99, help="Discount factor")
    parser.add_argument("--epsilon-start", type=float, default=1.0, help="Initial epsilon")
    parser.add_argument("--epsilon-end", type=float, default=0.05, help="Final epsilon")
    parser.add_argument("--epsilon-decay-episodes", type=int, default=20000, help="Episodes over which epsilon decays")
    ...
    parser.add_argument("--alpha-decay-episodes", type=int, default=20000, help="Episodes over which alpha decays")
    parser.add_argument("--eval-window", type=int, default=100, help="Window size for win-rate calculation")
    parser.add_argument("--log-interval", type=int, default=100, help="Episodes between logging/win-rate capture")
